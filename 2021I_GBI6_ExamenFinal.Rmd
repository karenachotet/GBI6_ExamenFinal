...
ggsave("result/boxplot3.png", width = 6, height = 8, dpi = 300)
...
ggsave("result/regresion11.pdf", width = 6, height = 8, dpi = 300)
...
```{tex}
# Interpreación sobre boxplot3.png
#La gráfica de LUCS muestra la distribución de los datos muestran el nivel de
expresion de la enfermedad LUCS(Lung squamous cell carcinoma). Según la 
media, se puede considerar que el nivel de expresion de los genes de la 
enfermedad son bajos ya que los datos se encientran por debajo del #5o% de la 
media
